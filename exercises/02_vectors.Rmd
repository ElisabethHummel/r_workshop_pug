...
# Der Vektortyp muss immer gleich sein. Mischungen funktionieren nicht, siehe unten Bsp.
...
```{r}
Elli_vector_zahl <-c(1,2.5,3,4.5)
Elli_vector_zahl
```
```{r}
Elli_vector_buchstaben <-c("hallo", "Julia")
Elli_vector_buchstaben
best_animal<- "tiger"
```
...
c(2, 4, 6, 5, 0, 0) + c(1, 10,1, 10,1, 10)
```
